              ...
              <div>
                ...
                >
                  <div class="row space-y-4">
                    <div class="w-4/12">
                      <img
                        class="rounded-md object-cover h-20"
                    ...
                    <div class="w-8/12 flex flex-col">
                      <h6 class="h-full mt-2">
                        <nuxt-link
                          :to="{
                            name: 'articles-slug',
                            params: { slug: related_article.slug },
                          }"
...
export default {
  async asyncData({ $dataApi, $axios, params }) {
    const response = await $dataApi.get(
      `/v1/application/articles/${params.slug}`
    );
    const article = response.data;
    const related_articles = response.related_articles;
    return {
      article,
      related_articles,
    };
